...
1. Text: Áreas destinadas a mostrar texto estático. Generalmente son rectángulos con texto legible o bloques de palabras.
...
2. Input: Campos donde los usuarios pueden ingresar información. Estos son típicamente rectángulos más largos que altos.
...
3. Button: Botones que los usuarios pueden presionar. Suelen ser rectángulos con palabras breves como 'Enviar' o 'Cancelar'.
...
- Solo deberás devolver la cantidad de componentes clasificados en cada grupo.
"""
