from agents.classifier.components_examples import inputs_contours_examples, buttons_contours_examples, text_contours_examples
...
un formulario de login con un campo de usuario, un campo de correo electronico, un campo de contraseña y un botón de enviar.
...
- Solo deberás devolver la cantidad de componentes clasificados (no los contornos) en cada grupo en forma de string, con
